...
class LockedBoardDetector:
    ...
    def _capture_empty_baselines(self, hsv: np.ndarray):
        ...
        Sample median HSV at each grid cell and skip cells where the median
        clearly indicates a piece (red or yellow hue with high saturation).
        This lets adaptive mode work correctly even when the board is not
        fully empty at lock time.
        """
